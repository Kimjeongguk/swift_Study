...
- (void)SetDeviceInfo:(NSString *)sURL PathName:(NSString*)sPathName userId:(NSString *)sID userPW:(NSString *)sPasswd deviceToken:(NSString *)token minkNewUserName:(NSString*)sminkNewUserName;
...
+ (NSString *)ToHexStringFromDeviceToken:(NSData *)deviceToken;
@end
